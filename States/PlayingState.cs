...
namespace Tetris.States
{
    internal class PlayingState : GameState
    {
        ...
        TextGameObject playAgain = new TextGameObject("Fonts/Instructions", 1f, Color.White);
        ...
        public PlayingState()
        {
            ...
            playAgain.LocalPosition = new Vector2(433, 625);
            playAgain.Text = "Game Over\nPress Enter\nto Play Again";
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (rowsCleared > 0)
            {
                ...
                if (rowMatchDetectionTimer <= 0)
                {
                    ...
                    if (totalRowsCleared >= targetRowsToClear)
                    {
                        ...
                        descensionTimer -= subtractTime;

                        subtractTime -= (subtractTime * .05f);
            ...
            if (CurrentProcess == Process.Stopped)
